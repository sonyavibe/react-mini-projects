...
export const Users = ({ items, searchValue, onChangeSearchValue, invites, onClickInvite, onClickSendInvites }) => {
  return (
    <>
        ...
        <ul className="users-list">
          {
            items.filter(obj => {
              ...
              return fullName.includes(searchValue.toLowerCase()) || obj.email.toLowerCase().includes(searchValue);
